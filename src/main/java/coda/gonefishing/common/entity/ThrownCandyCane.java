package coda.gonefishing.common.entity;
...
public class ThrownCandyCane extends AbstractArrow {
   ...
   private static final EntityDataAccessor<Boolean> ID_FOIL = SynchedEntityData.defineId(ThrownCandyCane.class, EntityDataSerializers.BOOLEAN);
   private ItemStack item = new ItemStack(NLItems.CANDY_CANE.get());
   private boolean dealtDamage;
   public int clientSideReturnTridentTickCount;

   public ThrownCandyCane(EntityType<? extends ThrownCandyCane> p_37561_, Level p_37562_) {
      super(p_37561_, p_37562_);
   }

   public ThrownCandyCane(Level p_37569_, LivingEntity p_37570_, ItemStack p_37571_) {
      super(NLEntities.CANDY_CANE.get(), p_37570_, p_37569_);
   ...
   public void readAdditionalSaveData(CompoundTag p_37578_) {
      ...
      if (p_37578_.contains("CandyCane", 10)) {
         this.item = ItemStack.of(p_37578_.getCompound("CandyCane"));
      }
   ...
   public void addAdditionalSaveData(CompoundTag p_37582_) {
      ...
      p_37582_.put("CandyCane", this.item.save(new CompoundTag()));
